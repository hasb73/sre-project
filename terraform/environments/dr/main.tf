# DR Region Environment Configuration
...
module "networking" {
  ...
  peer_database_subnet_address_prefix = var.primary_database_subnet_address_prefix
...
module "aks" {
  ...
  create_acr             = false  # ACR is shared from primary region
